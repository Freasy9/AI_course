...
export default function StatusBar() {
  ...
  return (
    <header className="flex items-center justify-between px-4 sm:px-6 py-2 sm:py-3 tech-border tech-border-scifi bg-[var(--lab-panel)] border-b-2 border-[var(--lab-border-strong)] shadow-[0_0_24px_rgba(124,58,237,0.12)]">
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <span className="lab-brand-title font-lab-display font-bold text-sm sm:text-base tracking-[0.12em]">
          质心教育
        </span>
      </div>
